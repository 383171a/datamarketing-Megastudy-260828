# DCL 
# mysql은 현재 나의 mysql에 접근 가능한 사용자 목록을 보여줄 수 있는 내장 객체
# user 속성을 사용하면 사용자 목록을 볼 수 있다.
# host, user 컬럼 조회 가능
...
# localhost : 내부에서만 = 내컴퓨터 = 고유한 (호스트 주소)IP 회선에서 접속이 가능한 제약요건 
...
GRANT ALL ON sakila.actor TO "megastudyglobal"@"%";
GRANT ALL ON sakila.* TO "megastudyglobal"@"%"; #  sakila의 모든 ALL 
GRANT ALL ON *.* TO "megastudyglobal"@"%"; # ALL
